...
sc.pl.umap(adata_gene, color=["Gsn", "Ctss", "Egfl7", 'leiden'])
...
# %%
adata_annot = sc.read_h5ad(os.path.join(DATA_PATH, "scATAC_scanvi_annot.h5ad"))

# %%
adata_annot.obs['cell_type_fine'] = adata_annot.obs['predicted_labels'].copy()
...
adata_annot.obs['cell_type'] = adata_annot.obs['cell_type_fine'].str.extract(r'(' + '|'.join(annot_map.keys()) + ')')[0].map(annot_map)

# %%
adata_annot.write_h5ad(os.path.join(DATA_PATH, "scATAC_scanvi_annot.h5ad"), compression="gzip")

# %%
adata_gene = sc.read_h5ad(os.path.join(DATA_PATH, "scATAC_all_gene_activity.h5ad"))

# %%
adata_gene.obs['cell_type'] = adata_annot.obs['cell_type'].copy()
adata_gene.obs['cell_type_fine'] = adata_annot.obs['cell_type_fine'].copy()
